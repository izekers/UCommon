...
import net.zoker.ucommon.app.tasks.domain.filter.TaskFilter;
...
public class GetTasks extends UseCase<GetTasks.RequestValues, GetTasks.ResponseValue> {
    ...
    public GetTasks(@NonNull TasksDataSource tasksRepository, @NonNull FilterFactory filterFactory) {
